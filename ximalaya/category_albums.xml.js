function getCategoryAlbumsDoc(categoryID, title, callback) {
    var url = `http://mobile.ximalaya.com/mobile/discovery/v1/category/filter/albums?calcDimension=hot&categoryId=${categoryID}&device=iPhone&pageId=1&pageSize=20&version=5.4.45`;
...
function showCategoryAlbums(categoryID, title) {
    const loadingDocument = createLoadingDocument("Ximalaya加载中..");
    navigationDocument.pushDocument(loadingDocument);
    getCategoryAlbumsDoc(categoryID, title, function(doc){
